...
public class ASDamageConverter {
    ...
    static ASDamageConverter getASDamageConverter(Entity entity, AlphaStrikeElement element, CalculationReport report) {
        if (element.isBattleArmor()) {
            ...
            return new ASDamageConverter(entity, element, report);
        }
    }
