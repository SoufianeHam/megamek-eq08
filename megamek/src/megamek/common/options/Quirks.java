...
public class Quirks extends AbstractOptions {
    ...
    public static boolean isQuirkLegalFor(IOption quirk, Entity en) {
        ...
        if (en instanceof Mech) {
            ...
            return (en.getWeight() > 55) && (qName.equals(OptionsConstants.QUIRK_POS_COMPACT));
        }
        ...
        if (en instanceof Tank) {
            ...
            if (qName.equals(OptionsConstants.QUIRK_POS_POWER_REVERSE)) {
                return (en.getMovementMode() != EntityMovementMode.WHEELED
                ...
                return true;
            } else if (qName.equals(OptionsConstants.QUIRK_POS_ATMO_FLYER) || qName.equals(OptionsConstants.QUIRK_POS_ANIMALISTIC) || qName.equals(OptionsConstants.QUIRK_POS_BARREL_FIST_LA) || qName.equals(OptionsConstants.QUIRK_POS_BARREL_FIST_RA) || qName.equals(OptionsConstants.QUIRK_POS_COMBAT_COMPUTER) || qName.equals(OptionsConstants.QUIRK_POS_COMMAND_MECH) || qName.equals(OptionsConstants.QUIRK_POS_COWL) || qName.equals(OptionsConstants.QUIRK_POS_DIRECTIONAL_TORSO_MOUNT) || qName.equals(OptionsConstants.QUIRK_POS_DOCKING_ARMS) || qName.equals(OptionsConstants.QUIRK_POS_EASY_PILOT) || qName.equals(OptionsConstants.QUIRK_POS_EXT_TWIST) || qName.equals(OptionsConstants.QUIRK_POS_FINE_MANIPULATORS) || qName.equals(OptionsConstants.QUIRK_POS_HYPER_ACTUATOR) || qName.equals(OptionsConstants.QUIRK_POS_IMP_LIFE_SUPPORT) || qName.equals(OptionsConstants.QUIRK_POS_INTERNAL_BOMB) || qName.equals(OptionsConstants.QUIRK_POS_MULTI_TRAC) || qName.equals(OptionsConstants.QUIRK_POS_NIMBLE_JUMPER) || qName.equals(OptionsConstants.QUIRK_POS_REINFORCED_LEGS) || qName.equals(OptionsConstants.QUIRK_POS_STABLE) || qName.equals(OptionsConstants.QUIRK_POS_OVERHEAD_ARMS) || qName.equals(OptionsConstants.QUIRK_POS_COMPACT) || qName.equals(OptionsConstants.QUIRK_POS_BATTLE_FIST_RA) || qName.equals(OptionsConstants.QUIRK_POS_BATTLE_FIST_LA) || qName.equals(OptionsConstants.QUIRK_POS_PRO_ACTUATOR) || qName.equals(OptionsConstants.QUIRK_NEG_ATMO_INSTABILITY) || qName.equals(OptionsConstants.QUIRK_NEG_CRAMPED_COCKPIT) || qName.equals(OptionsConstants.QUIRK_NEG_DIFFICULT_EJECT) || qName.equals(OptionsConstants.QUIRK_NEG_EXP_ACTUATOR) || qName.equals(OptionsConstants.QUIRK_NEG_NO_ARMS) || qName.equals(OptionsConstants.QUIRK_NEG_NO_EJECT) || qName.equals(OptionsConstants.QUIRK_NEG_NO_TWIST) || qName.equals(OptionsConstants.QUIRK_NEG_LARGE_DROPPER) || qName.equals(OptionsConstants.QUIRK_NEG_LOW_ARMS) || qName.equals(OptionsConstants.QUIRK_NEG_POOR_LIFE_SUPPORT) || qName.equals(OptionsConstants.QUIRK_NEG_UNBALANCED) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_LEGS) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_UNDERCARRIAGE) || qName.equals(OptionsConstants.QUIRK_POS_VTOL_ROTOR) || qName.equals(OptionsConstants.QUIRK_NEG_FLAWED_COOLING) || qName.equals(OptionsConstants.QUIRK_NEG_UNSTREAMLINED) || qName.equals(OptionsConstants.QUIRK_NEG_GAS_HOG) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_HEAD_1) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_HEAD_2) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_HEAD_3) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_HEAD_4) || qName.equals(OptionsConstants.QUIRK_NEG_WEAK_HEAD_5) || qName.equals(OptionsConstants.QUIRK_POS_VESTIGIAL_HANDS_LA) || qName.equals(OptionsConstants.QUIRK_POS_VESTIGIAL_HANDS_RA)) {
                return true;
            }
