...
public class TripodMechMapSet implements DisplayMapSet {
    ...
    // right Leg
    private final Polygon rightLeg = new Polygon(new int[] { 107, 104, 88, 77, 70, 70,
            64, 82, 80, 80, 82, 81, 106, 105, 107 }, new int[] { 104, 104, 63, 82,
            82, 85, 85, 103, 103, 121, 121, 129, 129, 122, 122 }, 15);

    private final Polygon centerLeg = new Polygon(new int[] {49, 49, 75, 75, 64, 61},
    ...
    private final Polygon inStCenterLeg = new Polygon(new int[] {53, 53, 74, 74}, new int[] {203, 230, 230, 203}, 4);
