...
public class TWAdvancedSearchPanel extends JPanel implements ActionListener, ItemListener,
    ...
    // Weapons / Equipment
    private final JButton btnWELeftParen = new JButton("(");
    private final JButton btnWERightParen = new JButton(")");
    private final JButton btnWEAdd = new JButton(Messages.getString("MechSelectorDialog.Search.add"));
    private final JButton btnWEAnd = new JButton(Messages.getString("MechSelectorDialog.Search.and"));
    private final JButton btnWEOr = new JButton(Messages.getString("MechSelectorDialog.Search.or"));
    private final JButton btnWEClear = new JButton(Messages.getString("MechSelectorDialog.Reset"));
    private final JButton btnWEBack = new JButton("Back");
    private final JLabel  lblWEEqExpTxt = new JLabel(Messages.getString("MechSelectorDialog.Search.FilterExpression"));
    private final JTextArea  txtWEEqExp = new JTextArea("");
    private final JScrollPane expWEScroller = new JScrollPane(txtWEEqExp,
    ...
    private final JLabel lblTechLevelBase = new JLabel(Messages.getString("MechSelectorDialog.Search.TechLevel"));
    ...
    // Base
    private final JButton btnBaseClear = new JButton(Messages.getString("MechSelectorDialog.ClearTab"));
    ...
    private final JLabel lblTankTurrets = new JLabel(Messages.getString("MechSelectorDialog.Search.TankTurrets"));
    private final JTextField tStartTankTurrets = new JTextField(4);
    private final JTextField tEndTankTurrets= new JTextField(4);
    private final JLabel lblLowerArms = new JLabel(Messages.getString("MechSelectorDialog.Search.LowerArms"));
    private final JTextField tStartLowerArms = new JTextField(4);
    private final JTextField tEndLowerArms = new JTextField(4);
    private final JLabel lblHands = new JLabel(Messages.getString("MechSelectorDialog.Search.Hands"));
    private final JTextField tStartHands = new JTextField(4);
    private final JTextField tEndHands = new JTextField(4);
    ...
    private final JLabel lblOfficial = new JLabel(Messages.getString("MechSelectorDialog.Search.Official"));
    private final JComboBox<String> cOfficial = new JComboBox<>();
    private final JLabel lblCanon = new JLabel(Messages.getString("MechSelectorDialog.Search.Canon"));
    private final JComboBox<String> cCanon = new JComboBox<>();
    private final JLabel lblPatchwork = new JLabel(Messages.getString("MechSelectorDialog.Search.Patchwork"));
    private final JComboBox<String> cPatchwork = new JComboBox<>();
    private final JLabel lblInvalid = new JLabel(Messages.getString("MechSelectorDialog.Search.Invalid"));
    private final JComboBox<String> cInvalid = new JComboBox<>();
    private final JLabel lblFailedToLoadEquipment = new JLabel(Messages.getString("MechSelectorDialog.Search.FailedToLoadEquipment"));
    private final JComboBox<String> cFailedToLoadEquipment = new JComboBox<>();
    private final JLabel lblClanEngine = new JLabel(Messages.getString("MechSelectorDialog.Search.ClanEngine"));
    private final JComboBox<String> cClanEngine = new JComboBox<>();
    private final JLabel lblTableFilters = new JLabel(Messages.getString("MechSelectorDialog.Search.TableFilters"));
    private final JLabel lblSource = new JLabel(Messages.getString("MechSelectorDialog.Search.Source"));
    private final JTextField tSource = new JTextField(4);
    ...
    private final JLabel lblTons = new JLabel(Messages.getString("MechSelectorDialog.Search.Tons"));
    private final JTextField tStartTons = new JTextField(4);
    private final JTextField tEndTons = new JTextField(4);
    private final JLabel lblBV = new JLabel(Messages.getString("MechSelectorDialog.Search.BV"));
    private final JTextField tStartBV = new JTextField(4);
    private final JTextField tEndBV = new JTextField(4);
    private final JLabel lblCockpitType = new JLabel(Messages.getString("MechSelectorDialog.Search.CockpitType"));
    private final JList<TriStateItem> listCockpitType = new JList<>(new DefaultListModel<TriStateItem>());
    ...
    private final JList<TriStateItem> listArmorType = new JList<>(new DefaultListModel<TriStateItem>());
    ...
    private final JList<TriStateItem> listInternalsType = new JList<>(new DefaultListModel<TriStateItem>());
    private final JScrollPane spInternalsType = new JScrollPane(listInternalsType);
    private final JLabel lblEngineType = new JLabel(Messages.getString("MechSelectorDialog.Search.Engine"));
    private final JList<TriStateItem> listEngineType = new JList<>(new DefaultListModel<TriStateItem>());
    private final JScrollPane spEngineType = new JScrollPane(listEngineType);
    private final JLabel lblTechLevel = new JLabel(Messages.getString("MechSelectorDialog.Search.TechLevel"));
    private final JList<TriStateItem> listTechLevel = new JList<>(new DefaultListModel<TriStateItem>());
    private final JScrollPane spTechLevel = new JScrollPane(listTechLevel);
    private final JLabel lblTechBase = new JLabel(Messages.getString("MechSelectorDialog.Search.TechBase"));
    private final JList<TriStateItem> listTechBase = new JList<>(new DefaultListModel<TriStateItem>());
    private final JScrollPane spTechBase = new JScrollPane(listTechBase);

    // Transports
    private final JButton btnTransportsClear = new JButton(Messages.getString("MechSelectorDialog.ClearTab"));
    private final JLabel lblTroopSpace = new JLabel(Messages.getString("MechSelectorDialog.Search.TroopSpace"));
    private final JTextField tStartTroopSpace  = new JTextField(4);
    private final JTextField tEndTroopSpace = new JTextField(4);
    private final JLabel lblASFBays = new JLabel(Messages.getString("MechSelectorDialog.Search.ASFBays"));
    private final JTextField tStartASFBays = new JTextField(4);
    private final JTextField tEndASFBays = new JTextField(4);
    private final JLabel lblASFDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartASFDoors = new JTextField(4);
    private final JTextField tEndASFDoors = new JTextField(4);
    private final JLabel lblASFUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartASFUnits = new JTextField(4);
    private final JTextField tEndASFUnits = new JTextField(4);
    private final JLabel lblSmallCraftBays = new JLabel(Messages.getString("MechSelectorDialog.Search.SmallCraftBays"));
    private final JTextField tStartSmallCraftBays = new JTextField(4);
    private final JTextField tEndSmallCraftBays = new JTextField(4);
    private final JLabel lblSmallCraftDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartSmallCraftDoors = new JTextField(4);
    private final JTextField tEndSmallCraftDoors = new JTextField(4);
    private final JLabel lblSmallCraftUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartSmallCraftUnits = new JTextField(4);
    private final JTextField tEndSmallCraftUnits = new JTextField(4);
    private final JLabel lblMechBays = new JLabel(Messages.getString("MechSelectorDialog.Search.MechBays"));
    private final JTextField tStartMechBays = new JTextField(4);
    private final JTextField tEndMechBays = new JTextField(4);
    private final JLabel lblMechDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartMechDoors = new JTextField(4);
    private final JTextField tEndMechDoors = new JTextField(4);
    private final JLabel lblMechUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartMechUnits = new JTextField(4);
    private final JTextField tEndMechUnits = new JTextField(4);
    private final JLabel lblHeavyVehicleBays = new JLabel(Messages.getString("MechSelectorDialog.Search.HeavyVehicleBays"));
    private final JTextField tStartHeavyVehicleBays = new JTextField(4);
    private final JTextField tEndHeavyVehicleBays = new JTextField(4);
    private final JLabel lblHeavyVehicleDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartHeavyVehicleDoors = new JTextField(4);
    private final JTextField tEndHeavyVehicleDoors = new JTextField(4);
    private final JLabel lblHeavyVehicleUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartHeavyVehicleUnits = new JTextField(4);
    private final JTextField tEndHeavyVehicleUnits = new JTextField(4);
    private final JLabel lblLightVehicleBays = new JLabel(Messages.getString("MechSelectorDialog.Search.LightVehicleBays"));
    private final JTextField tStartLightVehicleBays = new JTextField(4);
    private final JTextField tEndLightVehicleBays = new JTextField(4);
    private final JLabel lblLightVehicleDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartLightVehicleDoors = new JTextField(4);
    private final JTextField tEndLightVehicleDoors = new JTextField(4);
    private final JLabel lblLightVehicleUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartLightVehicleUnits = new JTextField(4);
    private final JTextField tEndLightVehicleUnits = new JTextField(4);
    private final JLabel lblProtomechBays = new JLabel(Messages.getString("MechSelectorDialog.Search.ProtomechBays"));
    private final JTextField tStartProtomechBays = new JTextField(4);
    private final JTextField tEndProtomechBays = new JTextField(4);
    private final JLabel lblProtomechDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartProtomechDoors = new JTextField(4);
    private final JTextField tEndProtomechDoors = new JTextField(4);
    private final JLabel lblProtomechUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartProtomechUnits = new JTextField(4);
    private final JTextField tEndProtomechUnits = new JTextField(4);
    private final JLabel lblBattleArmorBays = new JLabel(Messages.getString("MechSelectorDialog.Search.BattleArmorBays"));
    private final JTextField tStartBattleArmorBays = new JTextField(4);
    private final JTextField tEndBattleArmorBays = new JTextField(4);
    private final JLabel lblBattleArmorDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartBattleArmorDoors = new JTextField(4);
    private final JTextField tEndBattleArmorDoors = new JTextField(4);
    private final JLabel lblBattleArmorUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartBattleArmorUnits = new JTextField(4);
    private final JTextField tEndBattleArmorUnits = new JTextField(4);
    private final JLabel lblInfantryBays = new JLabel(Messages.getString("MechSelectorDialog.Search.InfantryBays"));
    private final JTextField tStartInfantryBays = new JTextField(4);
    private final JTextField tEndInfantryBays = new JTextField(4);
    private final JLabel lblInfantryDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartInfantryDoors = new JTextField(4);
    private final JTextField tEndInfantryDoors = new JTextField(4);
    private final JLabel lblInfantryUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartInfantryUnits = new JTextField(4);
    private final JTextField tEndInfantryUnits = new JTextField(4);
    private final JLabel lblSuperHeavyVehicleBays = new JLabel(Messages.getString("MechSelectorDialog.Search.SuperHeavyVehicleBays"));
    private final JTextField tStartSuperHeavyVehicleBays = new JTextField(4);
    private final JTextField tEndSuperHeavyVehicleBays = new JTextField(4);
    private final JLabel lblSuperHeavyVehicleDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartSuperHeavyVehicleDoors = new JTextField(4);
    private final JTextField tEndSuperHeavyVehicleDoors = new JTextField(4);
    private final JLabel lblSuperHeavyVehicleUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartSuperHeavyVehicleUnits = new JTextField(4);
    private final JTextField tEndSuperHeavyVehicleUnits = new JTextField(4);
    private final JLabel lblDropshuttleBays = new JLabel(Messages.getString("MechSelectorDialog.Search.DropshuttleBays"));
    private final JTextField tStartDropshuttleBays = new JTextField(4);
    private final JTextField tEndDropshuttleBays = new JTextField(4);
    private final JLabel lblDropshuttleDoors = new JLabel(Messages.getString("MechSelectorDialog.Search.Doors"));
    private final JTextField tStartDropshuttleDoors = new JTextField(4);
    private final JTextField tEndDropshuttleDoors = new JTextField(4);
    private final JLabel lblDropshuttleUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.Units"));
    private final JTextField tStartDropshuttleUnits = new JTextField(4);
    private final JTextField tEndDropshuttleUnits = new JTextField(4);
    private final JLabel lblDockingCollars = new JLabel(Messages.getString("MechSelectorDialog.Search.DockingCollars"));
    private final JTextField tStartDockingCollars = new JTextField(4);
    private final JTextField tEndDockingCollars = new JTextField(4);
    private final JLabel lblBattleArmorHandles = new JLabel(Messages.getString("MechSelectorDialog.Search.BattleArmorHandles"));
    private final JTextField tStartBattleArmorHandles = new JTextField(4);
    private final JTextField tEndBattleArmorHandles = new JTextField(4);
    private final JLabel lblCargoBayUnits = new JLabel(Messages.getString("MechSelectorDialog.Search.CargoBayUnits"));
    private final JTextField tStartCargoBayUnits = new JTextField(4);
    private final JTextField tEndCargoBayUnits = new JTextField(4);
    private final JLabel lblNavalRepairFacilities = new JLabel(Messages.getString("MechSelectorDialog.Search.NavalRepairFacilities"));
    private final JTextField tStartNavalRepairFacilities = new JTextField(4);
    private final JTextField tEndNavalRepairFacilities = new JTextField(4);

    // Quirks
    private final JButton btnQuirksClear = new JButton(Messages.getString("MechSelectorDialog.ClearTab"));
    private final JLabel lblQuirkInclude = new JLabel("\u2611");
    private final JComboBox<String> cQuirkInclue = new JComboBox<>();
    private final JLabel lblQuirkExclude = new JLabel("\u2612");
    private final JComboBox<String> cQuirkExclude = new JComboBox<>();
    private final JLabel lblQuirkType = new JLabel(Messages.getString("MechSelectorDialog.Search.Quirk"));
    private final JList<TriStateItem> listQuirkType = new JList<>(new DefaultListModel<TriStateItem>());
    private final JScrollPane spQuirkType = new JScrollPane(listQuirkType);
    private final JLabel lblWeaponQuirkInclude = new JLabel("\u2611");
    private final JComboBox<String> cWeaponQuirkInclue = new JComboBox<>();
    private final JLabel lblWeaponQuirkExclude = new JLabel("\u2612");
    private final JComboBox<String> cWeaponQuirkExclude = new JComboBox<>();
    private final JLabel lblWeaponQuirkType = new JLabel(Messages.getString("MechSelectorDialog.Search.WeaponQuirk"));
    private final JList<TriStateItem> listWeaponQuirkType = new JList<>(new DefaultListModel<TriStateItem>());
    private final JScrollPane spWeaponQuirkType = new JScrollPane(listWeaponQuirkType);

    // Unit Type
    private final JButton btnUnitTypeClear = new JButton(Messages.getString("MechSelectorDialog.ClearTab"));
    private final JLabel lblFilterMech= new JLabel(Messages.getString("MechSelectorDialog.Search.Mech"));
    private final JButton btnFilterMech = new JButton("\u2610");
    private final JLabel lblFilterBipedMech= new JLabel(Messages.getString("MechSelectorDialog.Search.BipedMech"));
    private final JButton btnFilterBipedMech = new JButton("\u2610");
    private final JLabel lblFilterProtoMech= new JLabel(Messages.getString("MechSelectorDialog.Search.ProtoMech"));
    private final JButton btnFilterProtoMech = new JButton("\u2610");
    private final JLabel lblFilterLAM = new JLabel(Messages.getString("MechSelectorDialog.Search.LAM"));
    private final JButton btnFilterLAM = new JButton("\u2610");
    private final JLabel lblFilterTripod = new JLabel(Messages.getString("MechSelectorDialog.Search.Tripod"));
    private final JButton btnFilterTripod = new JButton("\u2610");
    private final JLabel lblFilterQuad = new JLabel(Messages.getString("MechSelectorDialog.Search.Quad"));
    private final JButton btnFilterQuad= new JButton("\u2610");
    private final JLabel lblFilterQuadVee = new JLabel(Messages.getString("MechSelectorDialog.Search.QuadVee"));
    private final JButton btnFilterQuadVee = new JButton("\u2610");
    private final JLabel lblFilterAero = new JLabel(Messages.getString("MechSelectorDialog.Search.Aero"));
    private final JButton btnFilterAero = new JButton("\u2610");
    private final JLabel lblFilterFixedWingSupport = new JLabel(Messages.getString("MechSelectorDialog.Search.FixedWingSupport"));
    private final JButton btnFilterFixedWingSupport = new JButton("\u2610");
    private final JLabel lblFilterConvFighter = new JLabel(Messages.getString("MechSelectorDialog.Search.ConvFighter"));
    private final JButton btnFilterConvFighter = new JButton("\u2610");
    private final JLabel lblFilterSmallCraft = new JLabel(Messages.getString("MechSelectorDialog.Search.SmallCraft"));
    private final JButton btnFilterSmallCraft = new JButton("\u2610");
    private final JLabel lblFilterDropship = new JLabel(Messages.getString("MechSelectorDialog.Search.Dropship"));
    private final JButton btnFilterDropship = new JButton("\u2610");
    private final JLabel lblFilterJumpship = new JLabel(Messages.getString("MechSelectorDialog.Search.Jumpship"));
    private final JButton btnFilterJumpship = new JButton("\u2610");
    private final JLabel lblFilterWarship = new JLabel(Messages.getString("MechSelectorDialog.Search.Warship"));
    private final JButton btnFilterWarship = new JButton("\u2610");
    private final JLabel lblFilterSpaceStation = new JLabel(Messages.getString("MechSelectorDialog.Search.SpaceStation"));
    private final JButton btnFilterSpaceStation = new JButton("\u2610");
    private final JLabel lblFilterInfantry = new JLabel(Messages.getString("MechSelectorDialog.Search.Infantry"));
    private final JButton btnFilterInfantry = new JButton("\u2610");
    private final JLabel lblFilterBattleArmor = new JLabel(Messages.getString("MechSelectorDialog.Search.BattleArmor"));
    private final JButton btnFilterBattleArmor = new JButton("\u2610");
    private final JLabel lblFilterTank = new JLabel(Messages.getString("MechSelectorDialog.Search.Tank"));
    private final JButton btnFilterTank = new JButton("\u2610");
    private final JLabel lblFilterVTOL = new JLabel(Messages.getString("MechSelectorDialog.Search.VTOL"));
    private final JButton btnFilterVTOL = new JButton("\u2610");
    private final JLabel lblFilterSupportVTOL = new JLabel(Messages.getString("MechSelectorDialog.Search.SupportVTOL"));
    private final JButton btnFilterSupportVTOL = new JButton("\u2610");
    private final JLabel lblFilterGunEmplacement = new JLabel(Messages.getString("MechSelectorDialog.Search.GunEmplacement"));
    private final JButton btnFilterGunEmplacement = new JButton("\u2610");
    private final JLabel lblFilterSupportTank = new JLabel(Messages.getString("MechSelectorDialog.Search.SupportTank"));
    private final JButton btnFilterSupportTank= new JButton("\u2610");
    private final JLabel lblFilterLargeSupportTank = new JLabel(Messages.getString("MechSelectorDialog.Search.LargeSupportTank"));
    private final JButton btnFilterLargeSupportTank= new JButton("\u2610");
    private final JLabel lblFilterSuperHeavyTank = new JLabel(Messages.getString("MechSelectorDialog.Search.SuperHeavyTank"));
    private final JButton btnFilterSuperHeavyTank = new JButton("\u2610");
    private final JLabel lblFilterOmni = new JLabel(Messages.getString("MechSelectorDialog.Search.Omni"));
    private final JButton btnFilterOmni = new JButton("\u2610");
    private final JLabel lblFilterMilitary = new JLabel(Messages.getString("MechSelectorDialog.Search.Military"));
    private final JButton btnFilterMilitary = new JButton("\u2610");
    private final JLabel lblFilterIndustrial = new JLabel(Messages.getString("MechSelectorDialog.Search.Industrial"));
    private final JButton btnFilterIndustrial = new JButton("\u2610");
    private final JLabel lblFilterWaterOnly = new JLabel(Messages.getString("MechSelectorDialog.Search.WaterOnly"));
    private final JButton btnFilterWaterOnly = new JButton("\u2610");
    private final JLabel lblFilterSupportVehicle = new JLabel(Messages.getString("MechSelectorDialog.Search.SupportVehicle"));
    private final JButton btnFilterSupportVehicle = new JButton("\u2610");
    private final JLabel lblFilterAerospaceFighter = new JLabel(Messages.getString("MechSelectorDialog.Search.AerospaceFighter"));
    private final JButton btnFilterAerospaceFighter = new JButton("\u2610");
    private final JLabel lblFilterDoomedOnGround = new JLabel(Messages.getString("MechSelectorDialog.Search.DoomedOnGround"));
    private final JButton btnFilterDoomedOnGround = new JButton("\u2610");
    private final JLabel lblFilterDoomedInAtmosphere = new JLabel(Messages.getString("MechSelectorDialog.Search.DoomedInAtmosphere"));
    private final JButton btnFilterDoomedInAtmosphere = new JButton("\u2610");
    private final JLabel lblFilterDoomedInSpace = new JLabel(Messages.getString("MechSelectorDialog.Search.DoomedInSpace"));
    private final JButton btnFilterDoomedInSpace = new JButton("\u2610");
    private final JLabel lblFilterDoomedInExtremeTemp = new JLabel(Messages.getString("MechSelectorDialog.Search.DoomedInExtremeTemp"));
    private final JButton btnFilterDoomedInExtremeTemp = new JButton("\u2610");
    private final JLabel lblFilterDoomedInVacuum = new JLabel(Messages.getString("MechSelectorDialog.Search.DoomedInVacuum"));
    private final JButton btnFilterDoomedInVacuum = new JButton("\u2610");
